...
| Property Access | `get_with_string[T]()`, `get_with_index[T]()`, `get_with_symbol[T]()` | Read properties from JavaScript objects |
| Property Mutation | `set_with_string[T]()`, `set_with_index[T]()`, `set_with_symbol[T]()` | Write properties to JavaScript objects |
| Function Invocation | `apply[Arg, Result]()`, `apply_with_string[Arg, Result]()` | Call JavaScript functions |
| Constructor Invocation | `new[Arg, Result]()`, `new_with_string[Arg, Result]()` | Create new JavaScript objects |
| Type Conversion | `cast[T]()`, `cast_from[T]()` | Convert between MoonBit and JavaScript types |
